    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(async (position) => {
            ...
            const options = {
                ...
                headers: {
                    "X-RapidAPI-Key":
                        "d9d28d9152msh073ee639d70e251p1c6288jsn008891a7e7c3",
...
function updateWeatherUI(data, unit) {
    ...
    feelsLike.innerHTML = `Feels Like: ${convertTemperature(
    ...
    const minTempCelsius = convertTemperature(data.main.temp_min, unit).toFixed(
        2
    );
    ...
    const maxTempCelsius = convertTemperature(data.main.temp_max, unit).toFixed(
        2
    );
...
btn.addEventListener("click", async () => {
    ...
    const options = {
        method: "GET",
        headers: {
            "X-RapidAPI-Key": "d9d28d9152msh073ee639d70e251p1c6288jsn008891a7e7c3",
            "X-RapidAPI-Host": "open-weather13.p.rapidapi.com",
        },
    };
    try {
